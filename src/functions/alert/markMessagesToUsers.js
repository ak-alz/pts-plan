...
export default function markMessagesToUsers(firstName, secondName) {
  ...
  messages.forEach((message) => {
    if (message.innerText.includes(`${firstName} ${secondName}`)
      ...
      message.previousElementSibling.style = `background-image: url(https://e.unicode-table.com/orig/81/912866cba59b54bb8f5271f6ac5a68.png);
