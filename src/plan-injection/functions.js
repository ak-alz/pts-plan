...
export function showCats() {
  ...
  function addCatInPage() {
    ...
    const leftBlock = document.querySelector('div#bx-left-menu');
    ...
    if (img) {
      ...
      img.style = `position: fixed; left: 0px; bottom: 0px; width: ${parseInt(getComputedStyle(document.querySelector('div#bx-left-menu')).width, 10)}px; height: auto;`;
