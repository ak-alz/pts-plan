...
- **Автозакрытие чужих уведомлений** (временно отключено в коде): Автоматически закрывает уведомления о комментариях, в которых вас не упомянули. Требует указания имени пользователя.
